...
\vspace*{0.4cm} % text starts 0.4cm under the top the header
    ...
    \begin{center}
        \cvtag{Data Sourcing} \cvtag{Web Scraping}\cvtag{Data Visualization}\cvtag{Machine Learning}\cvtag{Containerization}\cvtag{CI/CD}\cvtag{Claude}\cvtag{GitHub Copilot}
    \end{center}
