...
%%%%% MAIN SECTION %%%%%%%%%%%%%%%%%%%%
    \adjustbox{valign=t}{\begin{minipage}{13.3cm}
        ...
        \MySectionNoPic{2021}{Research Intern}{Berlin, Germany}{Berlin Institute of Health, Charité Berlin}{Modelling single cell RNA velocities with tools and techniques tradionally used in weather forecasting { @ \href{https://www.hidih.org/research/computational-oncology}{Computational Oncology Research Group, HiDiH}}} 
...
\sidebar{sideBarColor!25}
\newpageheader{titleBackColor}{Frederik}{Laubisch}{Data Scientist \faLightbulbO \hspace{1mm} Web Developer}{white}
...
\vspace*{0.4cm} % text starts 0.4cm under the top the header
    ...
    \begin{center}
        \cvtag{Data Sourcing} \cvtag{Web Scraping}\cvtag{Data Visualizaion}\cvtag{Machine Learning}\cvtag{Software Engineering}\cvtag{Containerization}\cvtag{Automation}
        \cvtag{CI/CD} \cvtag{Networking} \cvtag{DevOps}
        \cvtag{Cloud} \cvtag{Infrastructure}
    \end{center}
...
\begin{minipage}{11.3cm}%
    ...
    \adjustbox{valign=t}{\begin{minipage}{2cm}
    \begin{center}
        \includegraphics[width=1.5cm]{deepai.png}
    \end{center}
    \end{minipage}}
    \hfill \vline \hfill
    \adjustbox{valign=t}{\begin{minipage}{9cm}
        \begin{itemize}
            \scriptsize 
            \item \protect\href{https://www.coursera.org/account/accomplishments/specialization/certificate/FWVBKE6NLZAV}{AI for Medicine Specialization Certificate} \textit{(Coursera, 2021)}\\
            \textcolor{black}{Courses:} \color{black!70} AI for Medical Diagnosis, AI for Medical Prognosis, AI for Medical Treatment
            \item \protect\href{https://www.coursera.org/account/accomplishments/specialization/RZDPBY64YHTV}{Deep Learning Specialization Certificate} \textit{(Coursera, 2020)}\\
            \textcolor{black}{Courses:} \color{black!70} Neural Networks and Deep Learning, Improving Deep Neural Networks, Structuring Machine Learning Projects, Convolutional Neural Networks, Sequence Models
    ...
    \adjustbox{valign=t}{\begin{minipage}{9cm}
        \begin{itemize}
            \scriptsize 
            \item \protect\href{https://www.coursera.org/account/accomplishments/professional-cert/J5TEEVLPKXTL}{IBM Data Science Professional Certificate} (\textit{Coursera, 2019}) \\
            \textcolor{black}{Courses:} \color{black!70} Data Analysis with Python, Data Science Methodology, Machine Learning with Python, Data Visualization with Python, Databases and SQL for Data Science, Applied Data Science Capstone Project
        \end{itemize}
    \end{minipage}}
